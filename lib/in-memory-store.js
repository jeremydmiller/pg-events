...
function InMemoryStore(){
	...
	self.queueProjectionEvent = function(id, stream){
		self.queue.push({id: id, stream: stream});
	}
	...
	self.updateProjection = function(name, id, evt){
		var projection = require('./projections').findProjection(name);
	...
	self.storeProjectionError = function(eventId, projectionName, error){
		self.errors.push({id: eventId, projection: projectionName, error: error});
	}
