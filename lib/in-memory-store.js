...
function InMemoryStore(){
	...
	self.findView = function(type, id){
		return self.byId(type).find(id);
	}

	self.updateView = function(type, id, data){
		self.byId(type).update(id, data);
	}
	...
	self.findAggregate = function(name){
		return self.byId('$aggregates').find(name);
	}

	self.storeAggregate = function(name, data){
		self.byId('$aggregates').update(name, data);
	}
