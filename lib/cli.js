...
function listAllUsages(){
	...
	console.log('    daemon -- runs the asynchronous projection daemon in console mode');
	console.log();
	console.log('Flags:');
...
var commands = {
	...
	rebuild: function(options){
		...
		return client.config.rebuildAll();
	},

	daemon: function(options){
		return new AsyncDaemon(options.database).startWatching();
